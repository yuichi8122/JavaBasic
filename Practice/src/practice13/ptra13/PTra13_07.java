...
public class PTra13_07 {
	...
	public static void main(String[] args) {
		 ...
		 */
		while(true) {
			if(meta.damage(sh.attack())) {
				System.out.println(sh.getName()+"は"+meta.getName()+"との戦闘に勝利した");
				break;
			}

			if(sh.damage(meta.attack())) {
				System.out.println(meta.getName()+"は"+sh.getName()+"との戦闘に勝利した");
				break;
			}
		}
